...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
  ...
  <div class="site-wrap">
      ...
      <div class="container">
        <div class="d-flex align-items-center">
          ...
          <div class="col-lg-3 text-right">
            ...
            <a href="register.html" class="small btn btn-primary px-4 py-2 rounded-0"><span class="icon-users">
            </span>Cadastrar-se</a>
          </div>
    ...
    <div class="hero-slide owl-carousel site-blocks-cover">
      <div class="intro-section" style="background-image: url('images/centro.jpg');">
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-12 mx-auto text-center" data-aos="fade-up">
              <h1>Bullying não é brincadeira</h1>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row mb-5 justify-content-center text-center">
          <div class="col-lg-4 mb-5">
            <h2 class="section-title-underline mb-5">
              <span>Todos contra o bullying</span>
            </h2>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
            ...
            <div class="feature-1 border">
              ...
              <div class="feature-1-content">
                <h2>Bullying verbal</h2>
                <p>Palavras ofensivas</p>
